export default {
  async getComprehensiveRisk(lat, lng) {
    ...
    // Try FEMA API directly first (they may have enabled CORS)
    ...
    try {
      console.log(`🌊 Fetching official FEMA flood zone data...`);
      ...
      const floodRes = await fetch(femaUrl, { signal: controller.signal });
